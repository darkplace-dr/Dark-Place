...
function actor:init()
    ...
    self.animations = {
        ...
        ["battle/attack"]       = {"battle/spell", 1/15, false},
        ["battle/act"]          = {"battle/act", 1/15, false},
        ["battle/spell"]        = {"battle/spell", 1/15, false, next="battle/idle"},
        ["battle/item"]         = {"battle/item", 0.25, false, next="battle/idle"},
        ["battle/spare"]        = {"battle/act", 1/15, false, next="battle/idle"},

        ["battle/attack_ready"] = {"battle/spellready", 0.2, true},
        ...
        ["battle/transition"]   = {"battle/hurt", 1/15, false},
        ["battle/victory"]      = {"battle/idle", 1/10, false},

        -- Cutscene animations
        ["laugh"]               = {"laugh", 4/30, true},
        ["jump_ball"]           = {"ball", 1/15, true},
        ["defeat"]              = {"defeat", 0.5, true},
    }
    ...
    self.offsets = {
        ...
        ["battle/actready"] = {0, 0},
        ["battle/spell"] = {-13, 0},
        ["battle/spellready"] = {-13, 0},
        ["battle/item"] = {-9, -8},
        ["battle/itemready"] = {-9, -8},
        ["battle/defend"] = {-9, 0},
