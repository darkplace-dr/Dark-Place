---@class VaporEffect : Object
---@overload fun(...) : VaporEffect
local VaporEffect, super = Class(Object)

function VaporEffect:init(texture, x, y, after)
    super.init(self, x, y)
...
function VaporEffect:onAdd(parent)
    super.onAdd(self, parent)

    self.start_color = self.color
end

function VaporEffect:update()
    self.red_timer = self.red_timer + DTMULT
    self.color = ColorUtils.mergeColor(self.start_color, {229/255, 95/255, 1}, self.red_timer / 10)
