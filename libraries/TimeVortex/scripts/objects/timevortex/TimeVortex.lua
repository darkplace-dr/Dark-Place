...
function DarkTransition:init(final_y, options)
    ...
    if self.lighttransition == nil then self.lighttransition = true end
    ...
    self.spr_doorblack = Assets.getTexture("kristal/doorvortex")
    ...
    if self.useyou then
        if self.lighttransition == true then
            self.spr_susieu = Assets.getFrames("party/susie/light/walk/up")
            self.spr_krisu = Assets.getFrames("party/you/light/walk/up")
    
            self.spr_susie_lw_fall_u = Assets.getFrames("party/susie/vortexlight_transition/forward")
            self.spr_krisu_fall_lw = Assets.getFrames("party/you/vortexlight_transition/forward")
    
            self.spr_susieu_run = Assets.getFrames("party/susie/vortexlight_transition/run")
            self.spr_krisu_run = Assets.getFrames("party/you/vortexlight_transition/run")
    
            self.spr_susie_lw_fall_turn = Assets.getFrames("party/susie/vortexlight_transition/turn")
            self.spr_kris_fall_turnaround = Assets.getFrames("party/you/vortexlight_transition/turn")
    
            self.spr_susie_lw_fall_d = Assets.getFrames("party/susie/vortexlight_transition/light")
            self.spr_kris_fall_d_lw = Assets.getFrames("party/you/vortexlight_transition/light")
    
            self.spr_susie_dw_fall_d = Assets.getFrames("party/susie/vortexlight_transition/dark")
            self.spr_kris_fall_d_dw = Assets.getFrames("party/you/vortexlight_transition/dark")
    
            self.spr_susie_white_fall_d = Assets.getFrames("party/susie/vortexlight_transition/white")
            self.spr_kris_fall_d_white = Assets.getFrames("party/you/vortexlight_transition/white")
    
            self.spr_susie_dw_fall_smear = Assets.getFrames("party/susie/vortexlight_transition/smear")
            self.spr_kris_fall_smear = Assets.getFrames("party/you/vortexlight_transition/smear")
    
            self.spr_susie_dw_fall_ball = Assets.getFrames("party/susie/vortexlight_transition/ball")
            self.spr_kris_fall_ball = Assets.getFrames("party/you/vortexlight_transition/ball")
    
            self.spr_susie_dw_landed = Assets.getFrames("party/susie/vortexlight_transition/landed")
            self.spr_kris_dw_landed = Assets.getFrames("party/you/vortexlight_transition/landed")
        else
            self.spr_susieu = Assets.getFrames("party/susie/dark/walk/up")
            self.spr_krisu = Assets.getFrames("party/you/dark/walk/up")
    
            self.spr_susie_lw_fall_u = Assets.getFrames("party/susie/vortexdark_transition/forward")
            self.spr_krisu_fall_lw = Assets.getFrames("party/you/vortexdark_transition/forward")
    
            self.spr_susieu_run = Assets.getFrames("party/susie/vortexdark_transition/run")
            self.spr_krisu_run = Assets.getFrames("party/you/vortexdark_transition/run")
    
            self.spr_susie_lw_fall_turn = Assets.getFrames("party/susie/vortexdark_transition/turn")
            self.spr_kris_fall_turnaround = Assets.getFrames("party/you/vortexdark_transition/turn")
    
            self.spr_susie_lw_fall_d = Assets.getFrames("party/susie/vortexdark_transition/light")
            self.spr_kris_fall_d_lw = Assets.getFrames("party/you/vortexdark_transition/light")
    
            self.spr_susie_dw_fall_d = Assets.getFrames("party/susie/vortexdark_transition/dark")
            self.spr_kris_fall_d_dw = Assets.getFrames("party/you/vortexdark_transition/dark")
    
            self.spr_susie_white_fall_d = Assets.getFrames("party/susie/vortexdark_transition/white")
            self.spr_kris_fall_d_white = Assets.getFrames("party/you/vortexdark_transition/white")
    
            self.spr_susie_dw_fall_smear = Assets.getFrames("party/susie/vortexdark_transition/smear")
            self.spr_kris_fall_smear = Assets.getFrames("party/you/vortexdark_transition/smear")
    
            self.spr_susie_dw_fall_ball = Assets.getFrames("party/susie/vortexdark_transition/ball")
            self.spr_kris_fall_ball = Assets.getFrames("party/you/vortexdark_transition/ball")
    
            self.spr_susie_dw_landed = Assets.getFrames("party/susie/vortexdark_transition/landed")
            self.spr_kris_dw_landed = Assets.getFrames("party/you/vortexdark_transition/landed")
        end
    else
        if self.lighttransition == true then
            self.spr_susieu = Assets.getFrames("party/susie/light/walk/up")
            ...
            self.spr_susie_lw_fall_u = Assets.getFrames("party/susie/vortexlight_transition/forward")
            self.spr_krisu_fall_lw = Assets.getFrames("party/kris/vortexlight_transition/forward")
    
            self.spr_susieu_run = Assets.getFrames("party/susie/vortexlight_transition/run")
            self.spr_krisu_run = Assets.getFrames("party/kris/vortexlight_transition/run")
    
            self.spr_susie_lw_fall_turn = Assets.getFrames("party/susie/vortexlight_transition/turn")
            self.spr_kris_fall_turnaround = Assets.getFrames("party/kris/vortexlight_transition/turn")
    
            self.spr_susie_lw_fall_d = Assets.getFrames("party/susie/vortexlight_transition/light")
            self.spr_kris_fall_d_lw = Assets.getFrames("party/kris/vortexlight_transition/light")
    
            self.spr_susie_dw_fall_d = Assets.getFrames("party/susie/vortexlight_transition/dark")
            self.spr_kris_fall_d_dw = Assets.getFrames("party/kris/vortexlight_transition/dark")
    
            self.spr_susie_white_fall_d = Assets.getFrames("party/susie/vortexlight_transition/white")
            self.spr_kris_fall_d_white = Assets.getFrames("party/kris/vortexlight_transition/white")
    
            self.spr_susie_dw_fall_smear = Assets.getFrames("party/susie/vortexlight_transition/smear")
            self.spr_kris_fall_smear = Assets.getFrames("party/kris/vortexlight_transition/smear")
    
            self.spr_susie_dw_fall_ball = Assets.getFrames("party/susie/vortexlight_transition/ball")
            self.spr_kris_fall_ball = Assets.getFrames("party/kris/vortexlight_transition/ball")
    
            self.spr_susie_dw_landed = Assets.getFrames("party/susie/vortexlight_transition/landed")
            self.spr_kris_dw_landed = Assets.getFrames("party/kris/vortexlight_transition/landed")
        else
            self.spr_susieu = Assets.getFrames("party/susie/dark/walk/up")
            self.spr_krisu = Assets.getFrames("party/kris/dark/walk/up")
    
            self.spr_susie_lw_fall_u = Assets.getFrames("party/susie/vortexdark_transition/forward")
            self.spr_krisu_fall_lw = Assets.getFrames("party/kris/vortexdark_transition/forward")
    
            self.spr_susieu_run = Assets.getFrames("party/susie/vortexdark_transition/run")
            self.spr_krisu_run = Assets.getFrames("party/kris/vortexdark_transition/run")
    
            self.spr_susie_lw_fall_turn = Assets.getFrames("party/susie/vortexdark_transition/turn")
            self.spr_kris_fall_turnaround = Assets.getFrames("party/kris/vortexdark_transition/turn")
    
            self.spr_susie_lw_fall_d = Assets.getFrames("party/susie/vortexdark_transition/light")
            self.spr_kris_fall_d_lw = Assets.getFrames("party/kris/vortexdark_transition/light")
    
            self.spr_susie_dw_fall_d = Assets.getFrames("party/susie/vortexdark_transition/dark")
            self.spr_kris_fall_d_dw = Assets.getFrames("party/kris/vortexdark_transition/dark")
    
            self.spr_susie_white_fall_d = Assets.getFrames("party/susie/vortexdark_transition/white")
            self.spr_kris_fall_d_white = Assets.getFrames("party/kris/vortexdark_transition/white")
    
            self.spr_susie_dw_fall_smear = Assets.getFrames("party/susie/vortexdark_transition/smear")
            self.spr_kris_fall_smear = Assets.getFrames("party/kris/vortexdark_transition/smear")
    
            self.spr_susie_dw_fall_ball = Assets.getFrames("party/susie/vortexdark_transition/ball")
            self.spr_kris_fall_ball = Assets.getFrames("party/kris/vortexdark_transition/ball")
    
            self.spr_susie_dw_landed = Assets.getFrames("party/susie/vortexdark_transition/landed")
            self.spr_kris_dw_landed = Assets.getFrames("party/kris/vortexdark_transition/landed")
        end
    end
...
function DarkTransition:drawDoor(x, y, xscale, yscale, rot, color)
    ...
    local sprite
    local rannum = love.math.random(1,6)
    if rannum then
        sprite = Assets.getTexture("objects/vortex/backdrop_"..rannum)
    end
    love.graphics.setColor(color)
    --love.graphics.draw(sprite, x, y, rot, xscale, yscale, sprite:getWidth()/2, sprite:getHeight()/2)
    love.graphics.draw(sprite, x, y, 0, 2, 2, 640/4, 480/4)
...
function DarkTransition:update()
    ...
    if self.linecon then
        ...
        if (self.linetimer >= 1) then
            ...
            self:addChild(TimeVortexLine(x))
            self:addChild(TimeVortexLine(x2))
...
function DarkTransition:draw()
    ...
    if rannum then
        ...
        love.graphics.draw(sprite, 0, 0, 0, 2, 2, 640/4, 480/4)
    ...
    if (self.rect_draw == 1) then
        ...
        for i = 1, self.rect_amount do
            ...
            if (self.rsize[i] > 0) then
                ...
                local r_color = {1,1,1, 1}



                --Game.world:spawnObject(CloudsBG(0, 0), "objects")
    ...
    if (self.con == 31) then
        ...
        if ((math.floor(self.timer) >= 15) and not self.do_once13) then
            ...
            for i = 1, self.sparkles do
                local sparkle = TimeVortexSparkle(self.sparestar, self.kris_x + 15, self.kris_y + 15)
                sparkle:play(1 / 15)
