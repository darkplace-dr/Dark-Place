local BouncySoul, super = Class(Soul)

function BouncySoul:init(x, y)
    super.init(self, x, y)
...
function BouncySoul:doMovement()
...
function BouncySoul:jumpEnd()
	if self.gravity < 0 then
		self.gravity = 0
	end
end

function BouncySoul:jumpReset()
...
function BouncySoul:doGroundPound()
