local GildedLeafPiece, super = Class(Object)

function GildedLeafPiece:init(x, y, speed, handler)
    super.init(self)
    ...
    self.leafsprite = Sprite("world/wind/gold_leaf")
...
function GildedLeafPiece:update()
    super.update(self)
