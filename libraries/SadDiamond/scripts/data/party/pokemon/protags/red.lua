local character, super = Class(PartyMember, "red")


--WARNING THIS IS NOT FINIHED 
--ASLO RED HIMSELF IS NOT SUPPPOSSED TO FIGHT!!!
--THIS IS KINDA LIKE A PLACEHOLDER!!!
...
function character:init()
    ...
    self:setActor("red")
    self:setLightActor("red")
    --add this later please
    --self:setPokeActor("red"
