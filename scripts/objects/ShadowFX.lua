...
function ShadowFX:init(alpha, dontusehighlight, scale, highlight, priority)
    super.init(self, priority)

    self.alpha = alpha or 0.75
    self.dontusehighlight = dontusehighlight or false
...
function ShadowFX:draw(texture)
    ...
    Draw.setColor(0, 0, 0)
    if self.dontusehighlight ~= true then
