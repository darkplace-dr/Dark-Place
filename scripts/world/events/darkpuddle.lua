...
function DarkPuddle:init(data)
    ...
    self.outline = Sprite("world/maps/cliffs/darkwake_puddle_outline", 245, 210)
    self.outline:setScale(2)
    self.outline.layer = 6
	self:addChild(self.outline)
	
    self.puddle = Sprite("world/maps/cliffs/darkwake_puddle", 247, 220)
    self.puddle:setColor(68/255, 17/255, 82/255)
    self.puddle:setScale(2)
    self.puddle.layer = 7
	self:addChild(self.puddle)
	
    --[[self.puddle_mask = Sprite("world/maps/cliffs/darkwake_puddle", 247, 220)
