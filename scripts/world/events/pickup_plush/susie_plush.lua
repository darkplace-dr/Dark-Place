---@class susie_plush : Pickup
---@overload fun(...) : susie_plush
local susie_plush, super = Class(Event, "susie_plush")

function susie_plush:init(data)
    ...
    self.sprite = Sprite("world/events/pickup_plush/susie_plush")
...
function susie_plush:postLoad()
	self.old_parent = self.parent
end

function susie_plush:onInteract(player, dir)
	Assets.playSound("voice/susie")
