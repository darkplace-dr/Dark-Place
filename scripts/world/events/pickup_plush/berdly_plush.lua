...
function berdly_plush:init(data)
    ...
    self.sprite = Sprite("world/events/pickup_plush/berdly_plush")
...
function berdly_plush:postLoad()
	self.old_parent = self.parent
end

function berdly_plush:onInteract(player, dir)
