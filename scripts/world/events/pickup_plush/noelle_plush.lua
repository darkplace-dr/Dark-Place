---@class noelle_plush : Pickup
---@overload fun(...) : noelle_plush
local noelle_plush, super = Class(Event, "noelle_plush")

function noelle_plush:init(data)
    ...
    self.sprite = Sprite("world/events/pickup_plush/noelle_plush")
...
function noelle_plush:postLoad()
	self.old_parent = self.parent
end

function noelle_plush:onInteract(player, dir)
