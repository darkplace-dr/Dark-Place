...
function dess_plush:init(data)
    ...
    self.sprite = Sprite("world/events/pickup_plush/dess_plush")
...
function dess_plush:postLoad()
	self.old_parent = self.parent
end

function dess_plush:onInteract(player, dir)
