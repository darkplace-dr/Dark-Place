...
function Forest:load()
    ...
    self.timer:every(0.5, function()
        if self.world:inBattle() then
            ...
            self.world:spawnBullet("leaf_hazard_2", MathUtils.random(marker1.x, marker1.x+marker1.width), marker1.center_y, false)
            self.world:spawnBullet("leaf_hazard_2", MathUtils.random(marker2.x, marker2.x+marker2.width), marker2.center_y, true)
            self.world:spawnBullet("leaf_hazard_2", MathUtils.random(marker1.x, marker1.x+marker1.width), marker1.center_y, false)
            self.world:spawnBullet("leaf_hazard_2", MathUtils.random(marker2.x, marker2.x+marker2.width), marker2.center_y, true)
        end
    end)
