		...
		if not Game:getFlag("starbeans_first") then
			...
			for k,v in pairs(Game.party) do
				...
				elseif v.id == "brenda" then
                    ...
                    cutscene:showNametag("Brenda")
                    cutscene:text("* I don't care which one you use.", "happy", "brenda")
                    cutscene:text("* Just please don't call me sir-ma'am,[wait:5] that just sounds dumb.", "dissapointed", "brenda")
                    cutscene:text("* And to answer your question...", "neutral_side", "brenda")
