return {
    ...
    entrance = function(cutscene, event)
        ...
        cutscene:hideNametag()
        local brandon = cutscene:getCharacter("brandon_dreamscape")
    ...
    corridor = function(cutscene, event)
        ...
        cutscene:wait(cutscene:panTo(x, y-30))
        cutscene:showNametag("Susie")
        cutscene:text("* Hey,[wait:5] Brandon,[wait:5] it's us!", "sad_frown", "susie")
        cutscene:showNametag("Brandon")
        cutscene:text("* ...", "shaded_b", "brandon")
        cutscene:text("* Why can't I do anything right?", "shaded", "brandon")
        cutscene:showNametag("Susie")
        cutscene:text("* ...", "sad", "susie")
        cutscene:text("* Dude,[wait:5] are you okay?", "sad_frown", "susie")
        cutscene:showNametag("Brandon")
        cutscene:text("* Susie,[wait:5] my recklessness nearly got the both of us killed.", "sad", "brandon")
        cutscene:showNametag("Susie")
        cutscene:text("* Hey,[wait:5] don't beat yourself over that,[wait:5] we all make mistakes.", "nervous", "susie")
        cutscene:showNametag("Brandon")
        cutscene:text("* ...", "shaded_b", "brandon")
        cutscene:text("* Don't follow me.", "miffed", "brandon")
        cutscene:hideNametag()
        local brandon = cutscene:getCharacter("brandon_dreamscape")
        brandon:walkTo(x, -60, 4, "up")
        cutscene:wait(3.5)
        cutscene:showNametag("Susie")
        cutscene:text("* ...", "shy_down", "susie")
        cutscene:text("* We need to go after him,[wait:5] c'mon.", "annoyed_down", "susie")
        cutscene:hideNametag()
        cutscene:wait(cutscene:attachCamera())
    ...
    boss = function(cutscene, event)
        ...
        cutscene:wait(2)
        cutscene:showNametag("Susie")
        cutscene:text("* Hey,[wait:5] Brandon,[wait:5] listen...", "shy_down", "susie")
        cutscene:text("* Whatever's troubling you,[wait:5] we can help you through it.", "sincere", "susie")
        cutscene:showNametag("Brandon")
        cutscene:text("* I thought I told you not to follow me.", "shaded", "brandon")
        cutscene:showNametag("Susie")
        ...
        cutscene:startEncounter("brandon", true, {{"brandon", brandon}})
        ...
        if Game:getFlag("b_fight_violence") then
            ...
            cutscene:wait(2)
            brandon:setSprite("battle/hurt")
            brandon:shake(5)
            Assets.stopAndPlaySound("wing")
            cutscene:wait(1)
            cutscene:showNametag("Brandon")
            cutscene:text("* O-oh my god,[wait:5] I...", "shaded_b", "brandon")
            cutscene:text("* Susie,[wait:5] a-are you okay...?", "shaded_sad", "brandon")
            cutscene:showNametag("Susie")
            cutscene:text("* Y-yeah,[wait:5] I'm fine.", "bangs_smile", "susie")
            brandon:resetSprite()
            brandon:setFacing("left")
            cutscene:showNametag("Brandon")
            cutscene:text("* Why did you...", "shaded", "brandon")
            cutscene:hideNametag()
            cutscene:wait(1)
            susie:shake(5)
            Assets.stopAndPlaySound("wing")
            ...
            cutscene:text("* brandon,[wait:5] i...", "neutral_b", "dess")
            cutscene:text("* ik this may seem hard to believe but", "neutral_c", "dess")
            cutscene:text("* i care about you too my man", "neutral", "dess")
            ...
            cutscene:showNametag("Brandon")
            cutscene:text("* I...", "sad", "brandon")
            cutscene:text("* I'm so sorry.", "sad_b", "brandon")
            cutscene:showNametag("Susie")
            ...
            cutscene:showNametag("Brandon")
            cutscene:text("* R-really...?", "sad", "brandon")
            cutscene:showNametag("Susie")
            ...
            cutscene:text("* ...", "sad", "brandon")
            brandon:setFacing("left")
            cutscene:text("* Thank you,[wait:5] I care about you guys too.", "happy_tears", "brandon")
        else
            cutscene:showNametag("Brandon")
            cutscene:text("* I...", "shaded_b", "brandon")
            cutscene:hideNametag()
            cutscene:wait(1)
            brandon:shake(5)
            brandon:setSprite("down")
            Assets.stopAndPlaySound("wing")
            cutscene:wait(1)
            cutscene:showNametag("Brandon")
            cutscene:text("* I-I'm so sorry guys,[wait:5] I...", "shaded", "brandon")
            brandon:setSprite("down_crying")
            cutscene:text("* Why the hell did I attack you?!", "shaded_sad", "brandon")
            cutscene:showNametag("Susie")
            cutscene:text("* Brandon...", "sad", "susie")
            cutscene:hideNametag()
            susie:walkTo(brandon.x - 80, brandon.y - 5, 3, "right")
            cutscene:wait(4)
            cutscene:showNametag("Susie")
            ...
            cutscene:showNametag("Brandon")
            cutscene:text("* R-really...?", "shaded_sad", "brandon")
            cutscene:showNametag("Dess")
            cutscene:text("* yeah dude,[wait:5] like i said you're a pretty cool dude", "neutral", "dess")
            ...
            cutscene:wait(1)
            cutscene:showNametag("Brandon")
            cutscene:text("* I care about you guys too.", "happy_tears", "brandon")
        end
        cutscene:showNametag("Dess")
        ...
        cutscene:showNametag("Brandon")
        cutscene:text("* Oh,[wait:5] uhhh...", "neutral_side", "brandon")
        cutscene:text("* Where we are isn't really important right now.", "neutral", "brandon")
        cutscene:text("* So like,[wait:5] just close your eyes and relax for a bit...", "happy_side", "brandon")
        cutscene:text("* ... and we'll be right back at my room!", "happy_b", "brandon")
        cutscene:showNametag("Susie")
        ...
        cutscene:showNametag("Susie")
        cutscene:text("* Wait so like...[wait:10] we really did have a fight with Brandon?", "shy", "susie")
        cutscene:showNametag("Dess")
        ...
        if Game:getFlag("b_fight_violence") then
            ...
            Game:getPartyMember("susie"):addOpinion("brandon", 20)
            Game:getPartyMember("susie"):setOpinion("jamm", 5)
            Game:getPartyMember("dess"):addOpinion("susie", 15)
            Game:getPartyMember("dess"):addOpinion("brandon", 15)
            Game:getPartyMember("dess"):addOpinion("jamm", -10)
            Game:getPartyMember("brandon"):addOpinion("susie", 20)
            Game:getPartyMember("brandon"):addOpinion("dess", 25)
            Game:getPartyMember("brandon"):addOpinion("jamm", -20)
        elseif Game:getFlag("dungeonkiller") then
            ...
            cutscene:text("* But she genuinely cares about Brandon.", "annoyed", "susie")
            cutscene:showNametag("jamm")
            cutscene:text("* If only you knew, Susie.", "shaded_pissed", "jamm")
            cutscene:text("* If only you knew...", "shaded_frown", "jamm")
            cutscene:hideNametag()
            jamm:walkTo(x + 80, 680, 3, "down")
            dess:setFacing("down")
            susie:setFacing("down")
            ...
            Game:getPartyMember("dess"):addOpinion("brandon", 15)
            Game:getPartyMember("brandon"):addOpinion("susie", 20)
            Game:getPartyMember("brandon"):addOpinion("dess", 35)
        end
        cutscene:showNametag("Susie")
        cutscene:text("* Hey,[wait:5] Brandon,[wait:5] you awake?", "neutral", "susie")
        cutscene:showNametag("Brandon")
        cutscene:text("* Yeah,[wait:5] I am.", "", "brandon")
        cutscene:text("* I'm just getting dressed,[wait:5] so you guys can go ahead without me.", "", "brandon")
        cutscene:showNametag("Susie")
