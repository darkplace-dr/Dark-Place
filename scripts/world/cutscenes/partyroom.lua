                ...
                if Game:getFlag("b_fight") and Game:getFlag("dungeonkiller") then
                    if Game:getFlag("b_fight_violence") then
                        if not Game:getFlag("b_dialogue_jamm") then
                            ...
                            cutscene:text("* She even had to get in the way of your attack for god's sake!", "mad", "brandon")
                            ...
                            cutscene:showNametag("Brandon")
                            cutscene:text("* I...", "shock", "brandon")
                            cutscene:text("* Pardon my French, Jamm,[wait:5] but...", "mad", "brandon")
                            cutscene:text("* You nearly fucking KILLED me!", "livid", "brandon")
                            cutscene:text("* And you have the goddamn AUDACITY to say I'm making assumptions?!", "livid_b", "brandon")
                            cutscene:text("* I just...", "sad", "brandon")
                            cutscene:text("* Leave me alone...", "miffed", "brandon")
                            cutscene:text("* (Jamm...[wait:10] what happened to make you like this...?)", "frown_side", "brandon")
                            Game:setFlag("b_dialogue_jamm", true)
                            local brandon = Game:getPartyMember("brandon")
                            brandon:addOpinion("jamm", -15)
                            Game.world.music:fade(1, 0.5)
                        else
                            cutscene:text("* ...", "miffed", "brandon")
                        end
