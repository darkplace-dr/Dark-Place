                ...
                if Game:getFlag("b_fight") and Game:getFlag("dungeonkiller") then
                    if Game:getFlag("b_fight_violence") then
                        if not Game:getFlag("b_dialogue_jamm") then
                            ...
                            cutscene:text("* I know I was attacking you and all...", "neurtal_side", "brandon")
                            ...
                            cutscene:text("* Okay look,[wait:5] if it's about Ania,[wait:5] I have a few things to say about that.", "suspicious", "brandon")
                            ...
                            cutscene:text("* I'm sorry for your loss and all that,[wait:5] but this isn't gonna bring her back.", "neutral", "brandon")
                            cutscene:text("* Nothing will.[wait:10] Please just accept that.", "neutral_side", "brandon")
                            cutscene:text("* But you really need to get you're act together.", "miffed", "brandon")
