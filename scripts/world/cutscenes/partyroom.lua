                ...
                if Game:getFlag("b_fight") and Game:getFlag("dungeonkiller") then
                    if Game:getFlag("b_fight_violence") then
                        if not Game:getFlag("b_dialogue_jamm") then
                            Game.world.music:fade(0, 0.5)
                            cutscene:text("* Okay I really do have to ask now that I have a chance to do so.", "", "brandon")
                            cutscene:text("* What the HELL was that for?", "", "brandon")
                            cutscene:text("* I know I was attacking you and all...", "", "brandon")
                            cutscene:text("* But Susie literally told you not to keep attacking me.", "", "brandon")
                            cutscene:text("* She even had to warn me about your attacks for god's sake!", "", "brandon")
                            cutscene:text("* Why the hell are you acting this way?", "", "brandon")
                            cutscene:text("* Okay look,[wait:5] if it's about Ania,[wait:5] I have a few things to say about that.", "", "brandon")
                            cutscene:text("* Firstly,[wait:5] you don't have to take your anger and grief out on others.", "", "brandon")
                            cutscene:text("* And secondly,[wait:5] I mean this in the nicest way possible,[wait:5] but...", "", "brandon")
                            cutscene:text("* You need to get over her.", "", "brandon")
                            cutscene:text("* I'm sorry for your loss and all that,[wait:5] but this isn't gonna bring her back.", "", "brandon")
                            cutscene:text("* Nothing will.[wait:10] Please just accept that.", "", "brandon")
                            cutscene:text("* But you really need to get you're act together.", "", "brandon")
                            cutscene:text("* You are a father,[wait:5] you have a daughter to take care of.", "", "brandon")
                            cutscene:text("* If you're gonna mope around and attack your own friends...", "", "brandon")
                            cutscene:text("* Then I do not think you're gonna properly raise Marcy.", "", "brandon")
                            cutscene:text("* Now kindly,[wait:5] please change and grow as a person.", "", "brandon")
                        ...
                        cutscene:text("* Oh,[wait:5] hi Acoustic.", "", "brandon")
                        cutscene:text("* L-look,[wait:5] I'm really sorry I attacked you and the others...", "", "brandon")
                        cutscene:text("* You didn't really do anything to comfort me so I have to ask...", "", "brandon")
                        cutscene:text("* Are you upset with me?", "", "brandon")
                        cutscene:showNametag("Jamm")
                        cutscene:text("* ...", "shaded_neutral", "jamm")
                        cutscene:showNametag("Brandon")
                        cutscene:text("* Please,[wait:5] you've been making me really worried for you lately...", "", "brandon")
                        cutscene:text("* ...", "", "brandon")
                        cutscene:text("* Um,[wait:5] we can stop talking if you want to.", "", "brandon")
                    end
                else
