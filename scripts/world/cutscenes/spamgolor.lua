return {
    intro = function(cutscene, event)
        ...
        cutscene:text("* WHY,[wait:5] HELLO THERE !!", nil, "spamgolor")
        local spamgolor = cutscene:getEvent(13)
        spamgolor:setSprite("greeting")
        cutscene:text("* I'M YOUR FRIENDLY [[NumberOneRatedSalesman2011]]!", nil, "spamgolor")
        spamgolor:shake(3)
        spamgolor:setSprite("hurt")
        cutscene:text("[noskip]* SPAM-", nil, "spamgolor", {auto = true})
        spamgolor:setSprite("idle")
        spamgolor:slideTo(x + 300, y, 0.5)
        cutscene:text("* SPAMGOLOR M. SPAMGOLOR!", nil, "spamgolor")
        ...
        cutscene:showNametag("Spamgolor")
        cutscene:text("* HAVE YOU COME TO [[Microtransaction]] ONE OF MY PRODUCTS?", nil, "spamgolor")
        cutscene:text("* WAIT A MINUTE...", nil, "spamgolor")
        spamgolor:setSprite("wowza")
        spamgolor:slideTo(x + 200, y, 0.5)
        cutscene:text("* IS THAT A [[HeartShapedObject]] YOU HAVE THERE?", nil, "spamgolor")
        spamgolor:setAnimation("glitch")
        cutscene:text("* I MUST HAVE THAT [[Specil item]] AT ONCE!", nil, "spamgolor")
        cutscene:text("* WITH IT,[wait:5] I BET I'LL BE ABLE TO SURPASS THAT [[Copyright Infringement]]!", nil, "spamgolor")
        ...
        if susie then
            ...
            cutscene:showNametag("Spamgolor")
            spamgolor:setSprite("idle")
            cutscene:text("* EXACTLY!!!\n[wait:10]* THAT GUY'S A COMPLETE [[Ripoff]]!", nil, "spamgolor")
        ...
        cutscene:showNametag("Spamgolor")
        cutscene:text("* WOW,[wait:5] THAT WAS CERTAINLY [[A fight to remember]]!", nil, "spamgolor")
        cutscene:text("* HEY,[wait:5] I'VE ACTUALLY GOT A [[In-game store]] OF MY OWN.", nil, "spamgolor")
        cutscene:text("* IT'S IN THE [[Warp Zone]].[wait:10]\n* FIRST DOOR ON THE LEFT.", nil, "spamgolor")
        cutscene:text("* AND DON'T FORGET...", nil, "spamgolor")
        spamgolor:setAnimation("glitch")
        cutscene:text("* TO [[Rate 5 stars]]!!", nil, "spamgolor")
        cutscene:text("* EHAHAHAHA!", nil, "spamgolor")
        cutscene:hideNametag()
