                ...
                if buy == 1 then
                    if Game.money >= 700 then
                        ...
                        if itemcheck then
							...
							cutscene:text("* that this bat is signed and autographed by Daniel Vogelbach himself?", "wink", "magolor")
							...
							cutscene:text("* Y'know I think it's really been a shame that The Mets have been on a drystreak lately.", "angry", "magolor")
