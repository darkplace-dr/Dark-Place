...
<tileset version="1.10" tiledversion="1.10.0" name="objects" tilewidth="418" tileheight="725" tilecount="24" columns="0">
 <editorsettings>
  <export target="objects.lua" format="lua"/>
 </editorsettings>
 <grid orientation="orthogonal" width="1" height="1"/>
 <tile id="0">
  <image width="21" height="20" source="../../../assets/sprites/objects/tissuebox.png"/>
 </tile>
 <tile id="1">
  <image width="31" height="21" source="../../../assets/sprites/objects/laptop1.png"/>
  <animation>
 ...
 <tile id="2">
  <image width="31" height="21" source="../../../assets/sprites/objects/laptop2.png"/>
 </tile>
 <tile id="3">
  <image width="31" height="21" source="../../../assets/sprites/objects/laptop3.png"/>
 </tile>
 <tile id="4">
  <image width="14" height="17" source="../../../assets/sprites/objects/sketchbook.png"/>
 </tile>
 <tile id="5">
  <image width="15" height="725" source="../../../assets/sprites/objects/lightbulb1.png"/>
  <animation>
 ...
 <tile id="24">
  <image width="232" height="110" source="../../../assets/sprites/world/maps/hometown_ribbit/bg_building_library.png"/>
 </tile>
 <tile id="25">
  <image width="120" height="200" source="../../../assets/sprites/world/maps/hometown_ribbit/bg_lockers_l.png"/>
 </tile>
 <tile id="26">
  <image width="418" height="240" source="../../../assets/sprites/world/maps/hometown_ribbit/spr_shelter.png"/>
 </tile>
</tileset>
