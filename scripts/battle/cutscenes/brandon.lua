return {
    comfort1 = function(cutscene)
        ...
        cutscene:text("* Please,[wait:5] Brandon,[wait:5] you're a great friend,[wait:5] I don't want to fight you.", "sad_frown", "susie")
        cutscene:text("* And what makes you think that?", "shaded", "brandon")
        ...
        brandon:addMercy(10)
        brandon.comfort = brandon.comfort + 1
    end,
    ...
    dk_comfort2 = function(cutscene)
        ...
        cutscene:text("* Dess,[wait:5] I...", "shaded", "brandon")
        brandon:addMercy(15)
        brandon.comfort = brandon.comfort + 1
    end,
    ...
    dk_comfort3 = function(cutscene)
        local brandon = Game.battle:getEnemyBattler("brandon")
        cutscene:text("* Look,[wait:5] Brandon,[wait:5] I'm not mad at all for that whole Spamgolor thing.", "sad_frown", "susie")
        ...
        cutscene:text("* Susie...", "shaded", "brandon")
        brandon:addMercy(20)
        brandon.comfort = brandon.comfort + 1
    end,
    ...
    dk_comfort4 = function(cutscene)
        ...
        cutscene:text("* Guys,[wait:5] I...", "shaded", "brandon")
        brandon:addMercy(30)
